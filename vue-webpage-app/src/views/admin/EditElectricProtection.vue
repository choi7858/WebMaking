<template>
    <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white w-1/3 max-h-[500px] p-6 rounded-lg shadow-lg relative overflow-hidden flex flex-col">
            ...
            <h2 class="text-xl font-bold text-center mb-4">전기식 방호장치 편집</h2>
            ...
            <div class="flex-grow overflow-y-auto px-2">
                ...
                <div class="mb-4">
                    ...
                    <textarea v-model="electricProtectionData.description" rows="4"
            ...
            <div class="flex justify-end mt-4">
                <button @click="saveElectricProtection"
...
export default {
    ...
    watch: {
        existingData: {
            ...
            handler(newValue) {
                if (newValue) {
                    this.electricProtectionData = { ...newValue };
    ...
    methods: {
        ...
        async saveElectricProtection() {
            const formData = new FormData();
            formData.append("description", this.electricProtectionData.description || "");
            ...
            try {
                await axios.post("http://localhost:8080/api/rnd/electric-protection/save", formData, {
