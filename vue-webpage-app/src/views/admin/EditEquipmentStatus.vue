<template>
    <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white w-1/3 max-h-[500px] p-6 rounded-lg shadow-lg relative overflow-hidden flex flex-col">
            ...
            <h2 class="text-xl font-bold text-center mb-4">장비보유현황 편집</h2>
...
export default {
    ...
    methods: {
        ...
        async saveEquipmentStatus() {
            const formData = new FormData();
            formData.append("description", this.equipmentStatus.description || "");
            ...
            try {
                await axios.post("http://localhost:8080/api/business/equipment-status/save", formData, {
