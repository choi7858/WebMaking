<template>
    <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white w-1/3 max-h-[500px] p-6 rounded-lg shadow-lg relative overflow-hidden flex flex-col">
            ...
            <h2 class="text-xl font-bold text-center mb-4">CI 편집</h2>
            ...
            <div class="flex-grow overflow-y-auto px-2">
                ...
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">CI 설명</label>
                    <textarea v-model="ciData.description" rows="4"
...
export default {
    ...
    methods: {
        ...
        async saveCI() {
            ...
            formData.append("description", this.ciData.description || "");
            ...
            try {
                await axios.post("http://localhost:8080/api/ci/save", formData, {
