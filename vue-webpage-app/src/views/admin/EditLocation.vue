<template>
    <div class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white w-1/3 max-h-[500px] p-6 rounded-lg shadow-lg relative overflow-hidden flex flex-col">
            ...
            <h2 class="text-xl font-bold text-center mb-4">찾아오시는 길 편집</h2>
            ...
            <div class="flex-grow overflow-y-auto px-2">
                ...
                <div class="mb-4">
                    ...
                    <textarea v-model="locationData.description" rows="4"
...
export default {
    ...
    methods: {
        ...
        async saveLocation() {
            ...
            formData.append("description", this.locationData.description || "");
            ...
            try {
                await axios.post("http://localhost:8080/api/location/save", formData, {
