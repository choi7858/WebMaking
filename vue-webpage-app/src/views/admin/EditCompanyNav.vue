        ...
        <div v-if="visible" class="popup-overlay" @click.self="closePopup">
            <div class="popup-container" ref="diagramContainer">
                <div class="popup-header">
                    <h2 class="popup-title">회사소개 메뉴 편집</h2>
...
// 하위 메뉴 배열 (회사소개 하위 항목들)
const submenus = ref([
    { label: "CEO 인사말", type: "ceo-message", apiPath: "/api/ceo-message" },
    { label: "CI", type: "ci", apiPath: "/api/ci" },
    { label: "ESG 경영", type: "esg", apiPath: "/api/esg" },
    { label: "회사연혁", type: "history", apiPath: "/api/history" },
    { label: "조직도", type: "organization", apiPath: "/api/organization" },
    { label: "보유 면허 · 인증서", type: "certifications", apiPath: "/api/certifications" },
    { label: "찾아오시는 길", type: "location", apiPath: "/api/location" }
]);
...
function drawDiagram() {
    ...
    // 메인 노드: "회사소개"
    const mainNode = { x: 20, y: 100, width: 120, height: 40, label: "회사소개" };
