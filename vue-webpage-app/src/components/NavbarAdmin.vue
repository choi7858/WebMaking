...
import EditRnd from "@/views/admin/EditRnd.vue";
...
const nestedMapping = {
    ...
    "electronic-protection": { endpoint: "/api/rnd/electronic-protection", component: EditElectronicProtection },
    "electric-protection": { endpoint: "/api/rnd/electric-protection", component: EditElectricProtection },
    "coil-lift": { endpoint: "/api/rnd/coil-lift", component: EditCoilLift },
    "ssils": { endpoint: "/api/rnd/ssils", component: EditSSILS },
    "calibrator": { endpoint: "/api/rnd/calibrator", component: EditCalibrator },
    "scada": { endpoint: "/api/rnd/scada", component: EditSCADA },
    "automatic-control-system": { endpoint: "/api/performance/automatic-control-system", component: EditAutomaticControlSystem },
    "electric-work-status": { endpoint: "/api/performance/electric-work-status", component: EditElectricWorkStatus },
};
